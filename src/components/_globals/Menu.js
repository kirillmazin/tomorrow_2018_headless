  ...
  handleResize(){
      ...
      if(this.state.visibility  == 'hidden'){
        // show
          ...
          this.setState({
            menu_style: {backgroundColor:'rgba(255,255,255,0)',height: '100px', tansition:"all 500ms"}
  ...
  handleHamburgerMouseEnter(){
    ...
    if(this.state.visibility == 'hidden'){
      this.setState({
        ...
        top_bar:{transform:"rotate(0)", top: "15px",backgroundColor:this.state.ui_color_closed_state},
        bottom_bar:{transform:"rotate(0)", top: "15px",backgroundColor:this.state.ui_color_closed_state}
      })
  ...
  render() {
    ...
    return (
          ...
          <div className="hamburger-menu-module" ref={el => this.container = el} style={this.state.menu_style}>
              ...
              <Link to="/">
                    <div className="case-study-logo" style={this.state.logo_scale} onMouseEnter={() => this.handleLogoMouseEnter()} onMouseLeave={() => this.handleLogoMouseLeave()}>
              ...
              <div className="hamburger-menu" onClick={()=>this.hamburgerClick()}  onMouseEnter={() => this.handleHamburgerMouseEnter()} onMouseLeave={() => this.handleHamburgerMouseLeave()}>
              ...
              <div className="col-md-10 offset-md-1 no-gutters">
